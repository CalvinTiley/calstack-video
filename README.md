...
<p align="center">
    A compact and customisable video player library, built and tested in TypeScript.
</p>

<p align="center">
    <b>Customisable:</b> Dynamic controls and a separate CSS file.
    <br>
...
However, the video element is notoriously difficult to style. Specifically, styling HTML video controls to present them in a manner consistent across modern browsers is normally a nightmare.
...
Ensure the package is installed by using one of the following commands depending on your chosen package manger:
